...
{cynkrathis} provides some functions which contribute to this opinionated project workflow approach:
...
Now you might wonder where and how you can see which snapshots belong to which R version?
Good question!
...
- `renv.config.auto.snapshot`: @kirill FIXME
